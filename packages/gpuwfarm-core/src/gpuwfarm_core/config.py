...
All physical constants use FLORIS defaults unless noted. These configs are
consumed by the wake physics, the farm evaluator, and the LCOE/visual-impact
objectives. The optimizer-only ``GAConfig`` lives in the optimizer package.
"""
